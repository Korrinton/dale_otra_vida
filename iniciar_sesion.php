    ...
    $errors=[
        'login' => $_SESSION['errores_sesion'] ?? '',
        'registro' => $_SESSION['errores_registro'] ?? ''
    ];
    ...
    unset($_SESSION['errores_sesion'], $_SESSION['errores_registro'], $_SESSION['active_form']);
